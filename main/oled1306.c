...
void task_ssd1306_display_clear(uint8_t oled_address) {//清屏函数
	i2c_cmd_handle_t cmd;
...
void task_ssd1306_display_text(uint8_t oled_address,const void *arg_text) {  //显示字符
...
{
	uint8_t text_len = strlen(text);
	//xTaskCreate(&task_ssd1306_display_clear, "ssd1306_display_clear",  2048, NULL, 6, NULL);//清屏函数
	i2c_cmd_handle_t cmd;
...
void oled_APP(void)
{
	...
	//	(void *)"112233222ld!\nMulitine is OK!\nAnother line\ntemper is", 6, NULL);  //显示字符
	//xTaskCreate(&task_ssd1306_contrast, "ssid1306_contrast", 2048, NULL, 6, NULL);
	//xTaskCreate(&task_ssd1306_scroll, "ssid1306_scroll", 2048, NULL, 6, NULL);//滚动字体
}
