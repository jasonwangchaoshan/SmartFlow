...
static const uint16_t character_client_config_uuid2       = 0xFF05; 
...
static const uint8_t heat_Temperature_ccc[2]       = {0x11, 0x11};
...
static const esp_gatts_attr_db_t gatt_db[HRS_IDX_NB] =
{
    ...
    /* Client Characteristic Configuration Descriptor */
    [IDX_CHAR_CFG_D]  =
    {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&character_client_config_uuid2, ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE,
      sizeof(uint16_t), sizeof(heat_Temperature_ccc), (uint8_t *)heat_Temperature_ccc}},
